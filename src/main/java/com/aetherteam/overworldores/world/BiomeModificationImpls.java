...
import static net.minecraft.world.level.levelgen.GenerationStep.*;
...
public class BiomeModificationImpls {
    ...
    public record AddFeaturesBiomeModification(HolderSet<Biome> biomes, HolderSet<PlacedFeature> features, Decoration step) implements BiomesModificationData {
        ...
        public void modify(BiomeSelectionContext selectionContext, BiomeModificationContext modificationContext) {
            ...
            this.features.forEach(holder -> settings.addFeature(this.step, holder.aetherFabric$getKey()));
        }
        ...
        public void modify(BiomeSelectionContext selectionContext, BiomeModificationContext modificationContext) {
            ...
            for (Decoration step : this.steps) {
                for (Holder<PlacedFeature> feature : features) {
                    generationSettings.removeFeature(step, feature.aetherFabric$getKey());
                }
            }
        }
     ...
     */
    public record AddCarversBiomeModification(HolderSet<Biome> biomes, HolderSet<ConfiguredWorldCarver<?>> carvers, GenerationStep.Carving step) implements BiomesModificationData {
        public static final MapCodec<AddCarversBiomeModification> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
                ...
                GenerationStep.Carving.CODEC.fieldOf("step").forGetter(AddCarversBiomeModification::step)
        ...
        public void modify(BiomeSelectionContext selectionContext, BiomeModificationContext modificationContext) {
            ...
            for (Holder<ConfiguredWorldCarver<?>> carver : this.carvers) {
                generationSettings.removeCarver(step, carver.aetherFabric$getKey());
            }
        }
     ...
     */
    public record RemoveCarversBiomeModification(HolderSet<Biome> biomes, HolderSet<ConfiguredWorldCarver<?>> carvers, Set<GenerationStep.Carving> steps) implements BiomesModificationData {
        ...
        public static final MapCodec<RemoveCarversBiomeModification> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
                        ...
                        Codec.either(GenerationStep.Carving.CODEC.listOf(), GenerationStep.Carving.CODEC).xmap(
                                ...
                                set -> set.size() == 1 ? Either.right(set.toArray(GenerationStep.Carving[]::new)[0]) : Either.left(List.copyOf(set))).optionalFieldOf("steps", EnumSet.allOf(GenerationStep.Carving.class)).forGetter(RemoveCarversBiomeModification::steps))
     ...
     */
    public record AddSpawnCostsBiomeModification(HolderSet<Biome> biomes, HolderSet<EntityType<?>> entityTypes, MobSpawnSettings.MobSpawnCost spawnCost) implements BiomesModificationData {
        ...
        public static final MapCodec<AddSpawnCostsBiomeModification> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
                ...
                MobSpawnSettings.MobSpawnCost.CODEC.fieldOf("spawn_cost").forGetter(AddSpawnCostsBiomeModification::spawnCost)
