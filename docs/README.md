...
The Overworld Ores addon implements new Holystone variants of ore blocks that correlate to vanilla and modded ores, and will naturally spawn in the Aether dimension with similar spawn rates and ranges to their Overworld counterparts. Modded ore variants will only generate if a respective mod with that ore is installed. This addon does not cover compatibility for every modded ore, but modpack creators can suggest additional ores they would like to be added.

This addon is intended to help modpack makers who are looking to add certain ore blocks to the Aether without requiring the player to have to travel to the Overworld to mine for them, such as for Aether-only survival situations. Modpack creators can also configure all of the default features such as generation rates or recipe results however they desire using data packs.

Currently supported compatibility includes:

- Tin Ore; Thermal Foundation, Railcraft, Mekanism.
- Lead Ore; Thermal Foundation, Railcraft, Mekanism, Embers, Immersive Engineering.
- Silver Ore; Thermal Foundation, Railcraft, Embers, Immersive Engineering.
- Nickel Ore; Thermal Foundation, Railcraft, Immersive Engineering.
- Zinc Ore; Railcraft, Create.
- Uranium Ore; Mekanism, Immersive Engineering.
- Sulfur Ore; Thermal Foundation, Railcraft.
- Create's ore crushing recipes.
...
You can also support Overworld Ores and The Aether Team by telling your friends, joining our Discord server, and sharing our progress and announcements on social media. Every bit helps!

If you're interested in sponsoring Overworld Ores or The Aether Team, please [contact Oz#1986 on the Aether Community Discord](https://discord.gg/aethermod).

## :package: Download the latest releases
[![Modloader: Forge](https://img.shields.io/badge/mod%20loader-forge-CC974D?style=flat-square)](https://files.minecraftforge.net/net/minecraftforge/forge/)
[![Modrinth Downloads](https://img.shields.io/modrinth/dt/Nipqb0qe?color=00AF5C&logo=modrinth)](https://modrinth.com/mod/aether-overworld-ores)
[![Modrinth Version](https://img.shields.io/modrinth/game-versions/Nipqb0qe?color=00AF5C&label=latest&logo=modrinth&last=true)](https://modrinth.com/mod/aether-overworld-ores)
[![CurseForge Downloads](http://cf.way2muchnoise.eu/1237218.svg)](https://www.curseforge.com/minecraft/mc-mods/aether-overworld-ores)
...
repositories {
  ...
  maven githubPackage.invoke("The-Aether-Team/Overworld-Ores")
}
```

</details>

Then load it through your dependencies, with `project.overworld_ores_version` specified in the `gradle.properties`:
...
dependencies {
  ...
  implementation fg.deobf("com.aetherteam.aether_overworld_ores:aether_overworld_ores:${project.overworld_ores_version}")
  ...
}
```
...
If you're running into bugs or other problems, feel free to open an issue on our [issue tracker](https://github.com/The-Aether-Team/Overworld-Ores/issues). When doing so, make sure to use one of the provided templates and fill out all the requested information. Make sure to keep your issue's description clear and concise. Your issue's title should also be easy to digest, giving our developers and reporters a good idea of what's wrong without including too many details. Failure to follow any of the above may result in your issue being closed.

## :wrench: Contribute to the project
Looking to contribute to the project? We ask that you read over our [Contributor's Guide](https://github.com/The-Aether-Team/Overworld-Ores/blob/1.20.1-develop/docs/CONTRIBUTING.md) for more details as well as our [Contributor License Agreement (CLA)](https://github.com/The-Aether-Team/Overworld-Ores/blob/1.20.1-develop/docs/AGREEMENT.md) before getting started.

Not sure what to help with? Take a look at our issue tracker for some ideas! [Here's a quick link](https://github.com/The-Aether-Team/Overworld-Ores/labels/status%2Fhelp-wanted) which shows all the currently open issues that we'd love some help on.

## :scroll: License information
[![Asset license (Unlicensed)](https://img.shields.io/badge/assets%20license-All%20Rights%20Reserved-red.svg?style=flat-square)](https://en.wikipedia.org/wiki/All_rights_reserved)
[![Code license (LGPL v3.0)](https://img.shields.io/badge/code%20license-LGPL%20v3.0-green.svg?style=flat-square)](https://github.com/The-Aether-Team/Overworld-Ores/blob/1.20.1-develop/LICENSE.txt)

If you're wanting to create a gameplay video/review, extension or addon, parody, or any other fan work of your own for Overworld Ores, go for it! We love seeing the content our community creates, and we hope to make it as welcoming as possible for everyone. We ask however that you please don't advertise using our brand (our specific logo assets, team name, official social media posts).

If you are thinking about using Overworld Ores's code or assets, please note our licensing. **All assets of Overworld Ores are unlicensed and all rights are reserved to them by The Aether Team and their respective authors.** The source code of Overworld Ores is under the LGPL v3.0 license.
